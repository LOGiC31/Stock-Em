...
# Create Users
users = [
  { user_id: 'USR001', name: 'Philip Ritchey', uin: '123456', email: 'philip@example.com', contact_no: '555-1234', role: 'professor_admin', auth_level: 2 },
  { user_id: 'USR002', name: 'Paul Taele', uin: '654321', email: 'paul@example.com', contact_no: '555-5678', role: 'professor_admin', auth_level: 1 },
  { user_id: 'USR003', name: 'random TA', uin: '987654', email: 'randomTA@example.com', contact_no: '555-9876', role: 'assistants', auth_level: 0 }
]
...
# Create Items
items = [
  { item_id: 'ITM001', serial_number: 'SN12345', item_name: 'ipad', category: 'Electronics', quality_score: 90, currently_available: true, details: 'some desc about the ipad.' },
  { item_id: 'ITM002', serial_number: 'SN54321', item_name: 'mobilePhonePixel', category: 'Electronics', quality_score: 85, currently_available: true },
  { item_id: 'ITM003', serial_number: 'SN67890', item_name: 'Desk Chair', category: 'Furniture', quality_score: 75, currently_available: false, details: 'comfy chair indeed!' }
]
